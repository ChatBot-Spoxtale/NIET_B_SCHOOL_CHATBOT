...
URL = "https://www.nietbschool.ac.in/swavlamban"
OUTPUT_FILE = Path("../output/club_swavlamban.json")
...
def scrape_swavlamban():
    ...
    if not main_section:
        raise RuntimeError("Pravah content section not found")
...
def main():
    ...
    data = scrape_swavlamban()

    with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
        json.dump(data, f, indent=4, ensure_ascii=False)

    print("✅ Swavlamban club data scraped successfully")
